...
impl<P, E> Temperature<P, E>
where
    P: InputPin<Error = E> + OutputPin<Error = E>,
{
    pub fn new(one_wire_pin: P, mut delay: hal::Delay) -> OneWireResult<Self, E> {
    ...
    pub fn read(&mut self) -> OneWireResult<SensorData, E> {
        self.sensor.read_data(&mut self.one_wire_bus, &mut self.delay)
    }
}
